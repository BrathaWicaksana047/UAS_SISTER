            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex items-center justify-between">
                        ...
                        <button class="mt-2 bg-purple-900 font-medium px-4 py-2 rounded-md">
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="{{ route('admin/products/edit', ['id'=>$product->id]) }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-xl text-sm px-4 py-2 mb-4">Edit</a>
